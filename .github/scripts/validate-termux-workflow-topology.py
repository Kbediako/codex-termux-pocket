...
TEMP_MAINTENANCE_SCRIPT = REPO_ROOT / ".github" / "scripts" / "alpha12-maintenance.sh"
...
def main() -> None:
    ...
    temporary_maintenance = (
        TEMP_MAINTENANCE_SCRIPT.is_file()
        and "alpha12-maintenance:" in read("blocking-ci.yml")
    )
