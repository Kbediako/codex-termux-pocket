...
Follow the owner's requested publication workflow, including a direct `main`
commit when explicitly requested. Never enlist coding bots or merge an abandoned
PR's history without the owner's approval.
