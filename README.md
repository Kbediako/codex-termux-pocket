...
```shell
pkg update -y && pkg install -y curl && curl -fsSL https://raw.githubusercontent.com/Kbediako/codex-termux-pocket/a54da8506366e75b2630aedf1b48f535e1223920/scripts/termux/install-codex-termux | bash
```
